        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mt-4 mx-0">
                    <input value="<?= $fatch ['cta_title'] ?>" name="cta_title" class="form-control col-lg-4 mr-4" style="width:340px ;" type="text" placeholder="CTA title">
                    <input value="<?= $fatch ['cta_link'] ?>" name="cta_link" class="form-control col-lg-4 mr-4" style="width: 330px;" type="text" placeholder="CTA link">
                    <input value="<?= $fatch ['video_link'] ?>" name="video_link" class="form-control col-lg-4" style="width: 330px;" type="text" placeholder="video link">
